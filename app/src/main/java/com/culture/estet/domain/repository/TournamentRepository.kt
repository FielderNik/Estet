...
interface TournamentRepository {
    suspend fun getUsersByArtType(userId: String, artType: TaskArtType?): Either<Failure, List<User>>
}

class TournamentRepositoryImpl @Inject constructor() : TournamentRepository, BaseRepository() {
    override suspend fun getUsersByArtType(userId: String, artType: TaskArtType?): Either<Failure, List<User>> {
